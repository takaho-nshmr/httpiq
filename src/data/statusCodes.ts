...
export const statusCodes: StatusCode[] = [
  ...
  { code: 102, meaning: 'Processing', description: 'The server has accepted the request, but has not yet completed it', difficulty: 'advanced' },
  { code: 206, meaning: 'Partial Content', description: 'The server has fulfilled the partial GET request for the resource', difficulty: 'advanced' },
  { code: 300, meaning: 'Multiple Choices', description: 'The requested resource has multiple representations', difficulty: 'advanced' },
  { code: 307, meaning: 'Temporary Redirect', description: 'The requested resource resides temporarily under a different URI', difficulty: 'advanced' },
  { code: 308, meaning: 'Permanent Redirect', description: 'The target resource has been assigned a new permanent URI', difficulty: 'advanced' },
  { code: 402, meaning: 'Payment Required', description: 'Reserved for future use', difficulty: 'advanced' },
  { code: 406, meaning: 'Not Acceptable', description: 'The resource is not available in a format acceptable to the client', difficulty: 'advanced' },
  { code: 410, meaning: 'Gone', description: 'The requested resource is no longer available and will not be available again', difficulty: 'advanced' },
  { code: 411, meaning: 'Length Required', description: 'The request did not specify the length of its content', difficulty: 'advanced' },
  { code: 413, meaning: 'Payload Too Large', description: 'The request is larger than the server is willing or able to process', difficulty: 'advanced' },
  { code: 415, meaning: 'Unsupported Media Type', description: 'The request entity has a media type which the server does not support', difficulty: 'advanced' },
  { code: 418, meaning: "I'm a teapot", description: 'The server refuses to brew coffee because it is a teapot (April Fools joke)', difficulty: 'advanced' },
  { code: 422, meaning: 'Unprocessable Entity', description: 'The request was well-formed but was unable to be followed due to semantic errors', difficulty: 'advanced' },
  { code: 451, meaning: 'Unavailable For Legal Reasons', description: 'The server is denying access to the resource as a consequence of a legal demand', difficulty: 'advanced' },
  { code: 501, meaning: 'Not Implemented', description: 'The server does not support the functionality required to fulfill the request', difficulty: 'advanced' },
  { code: 502, meaning: 'Bad Gateway', description: 'The server received an invalid response from the upstream server', difficulty: 'advanced' },
  { code: 504, meaning: 'Gateway Timeout', description: 'The server did not receive a timely response from the upstream server', difficulty: 'advanced' },
  { code: 507, meaning: 'Insufficient Storage', description: 'The server is unable to store the representation needed to complete the request', difficulty: 'advanced' },
  { code: 511, meaning: 'Network Authentication Required', description: 'The client needs to authenticate to gain network access', difficulty: 'advanced' }
];

export const getStatusCodesByDifficulty = (difficulty: 'beginner' | 'intermediate' | 'advanced'): StatusCode[] => {
